...
export function QuickActionFAB({
  ...
  return (
    <div className="relative flex flex-col items-center shrink-0 select-none">
      ...
      <div className="absolute -top-3.5 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-slate-900 border border-slate-800 text-slate-400 pointer-events-none shadow-sm animate-bounce">
